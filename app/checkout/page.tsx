...
function CheckoutContent() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      router.replace("/booking/success?id=" + encodeURIComponent(d.id));
    } catch (e) {
    ...
    <main className="page">
      ...
      <div className="checkout-layout">
        <section>
          ...
          <p className="lead">
            Reba amakuru yawe mbere yo kohereza booking.
          </p>
        ...
        <aside className="checkout-summary">
          ...
          <p>
            <b>Location:</b> {location || "Will be provided"}
          </p>
        </aside>
      </div>
    </main>
